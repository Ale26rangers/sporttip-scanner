...
if controlla_password():
    ...
    # ---------------------------------------------------------
    # 🛰️ SCANNER SPORTTIP (Con doppia strategia) — dal VECCHIO
    # ---------------------------------------------------------
    ...
    # ---------------------------------------------------------
    # 🔮 PREDICTOR PROFESSIONALE — dal NUOVO
    # ---------------------------------------------------------
    ...
    # ---------------------------------------------------------
        ...
        swiss_rit_full = [32, 5, 26, 2, 4, 15, 21, 20, 23, 36, 18, 40, 28, 41, 37, 22, 10, 3, 34, 30, 13, 11, 33, 24, 12, 8, 42, 38, 31, 29, 27, 39, 19, 14, 9, 7, 35, 25, 17, 16, 6, 1]
        swiss_fort_rit_full = [6, 3, 1, 4, 2, 5]
